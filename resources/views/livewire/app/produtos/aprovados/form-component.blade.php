...
<div class="divider">
    <div class="divider-text">{{ __('DADOS DO PRODUTO APROVADO') }}</div>
</div>
<div wire:loading wire:target="imagem">
...
<div class="row">
    <div class="col-md-12 col-lg-4 mb-2">
        @include('laravel-livewire-forms::fields.fieldset.text',['field'=>$fragrancia])
    </div>
    <div class="col-md-12 col-lg-4 mb-2">
        @include('laravel-livewire-forms::fields.fieldset.text',['field'=>$sabor])
    </div>
    <div class="col-md-12 col-lg-4 mb-2">
        @include('laravel-livewire-forms::fields.fieldset.text',['field'=>$tamanho])
    </div>
</div>
<div class="row">
    <div class="col-md-12 mb-2">
