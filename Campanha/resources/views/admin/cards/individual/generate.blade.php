...
<div class="container-fluid">
    <div class="row">
           <?php
        //dd($produto->loja);
        $tipo_campanha = request()->query('campanha', 'lamina_fim_semana');
...
//
               ...
               if($produto->selos){
                ...
                $corselo= "#ccc";
//
//        $preurl = 'https://web.superalfa.coop.br/storage/';
        ...
        elseif($tipo_campanha == "eletro"){
            $bgstoriepromo = url('storage') . '/' . $midias_config->bg_stories_promo_eletro;
              //   dd('aguarde um instante'.$bgstoriepromo );
            $corpromo = "#fff";
        }
        ...
        if ($produto->fracionado == 1) {
            $precofracionado = "R$ ". Calcula($produto->preco_promocional,10, '/');
              ...
              if (isset($produto->preco_desconto)) {
                $selodesconto = 1 ;
                      $urlselomaisdeconoto = url('storage/'.$produto->selo_mais_desconto) ;
              }
               if($produtosparceiros = $produto->parceiros){
...
//
                  ...
                  if($lencountpromocional == 1 ):
                    $promoreaisfontsize = 'font-size: 210px; line-height: 160px;';
                  ...
                  elseif ($lencountpromocional == 3 ):
                     $promoreaisfontsize = 'font-size: 150px; line-height: 120px;  ';
           ...
           ?>
            ...
            <div class="d-flex">
                <div><a class="btn btn-primary me-3" href="?campanha=lamina_fim_semana"> Fim de Semana</a>  </div>
                <div><a class="btn btn-primary me-3" href="?campanha=lamina_segunda_terca">Segunda e Terça</a>  </div>
                <div><a class="btn btn-primary me-3" href="?campanha=lamina_terca_sabor">Terça do sabor</a>  </div>
                <div><a class="btn btn-primary me-3" href="?campanha=lamina_hortifruti"> Horti Fruti </a> </div>
                <div><a class="btn btn-primary me-3" href="?campanha=lamina_ofertas_arrasadoras"> Ofertas Arrasadoras</a>  </div>
                <div><a class="btn btn-primary me-3" href="?campanha=eletro"> Eletro</a>  </div>
                <div><a class="btn btn-primary me-3" href="?campanha=lamina_extra">Lâmina Extra </a> </div>
            </div>
            ...
            <div class="card" style="">
                ...
                >
                    <div class="card-content">
                        @if ($produto->app == 1)
                            @include('campanha::admin.cards.individual.produtoapp')
                        @else
                            @include('campanha::admin.cards.individual.produtopromo')
                        @endif
                    </div>
                </div>
                <div class="row">
                        ...
                        btn.addEventListener('click', function(e) {
                           //  alert('{{$idcard}}')
                            ...
                            axios.get('/sanctum/csrf-cookie').then(response => {
                                axios.post('{{ route('api.campanhas.cardsindividuais.save', $produto->id) }}', json).then(
                                    resp => {
                                        // console.log(resp)
                                        if (resp.status === 200) {
                        ...
                        btn.addEventListener('click', function(e) {
                            ...
                            domtoimage.toPng(node, {
                                ...
                                .then(function(dataUrl) {
                                    var img = new Image();
                                    img.src = dataUrl;
                                    window.saveAs(img.src, 'card.png')
                                    console.log('baixou')
                                    aguarde{{ $idcard }}.style.display = "none";
                                })
