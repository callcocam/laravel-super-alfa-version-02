        ...
        <div class="row">
            ...
            <div class="col-md-2 mb-2">
                @include('laravel-livewire-forms::fields.text', [
                    'field' => $arredondamento_produto_lamina,
                ])
            </div>
            ...
            <div class="col-md-4">
                @include('laravel-livewire-forms::fields.text', ['field' => $tamanho_fonte_desc_lamina])
            </div>
            <div class="col-md-4">
                @include('laravel-livewire-forms::fields.text', ['field' => $altura_linha_desc_lamina])
            </div>
            <div class="col-md-4">
