<div class="banner-content d-flex w-100 h-100 justify-content-around">
    <div style="padding: 15px; width: 350px">
        <img style="max-height: 310px" src="{{ url('banners/appclube.fw.png')}}">
    </div>
    <div class="card-imagem d-flex justify-content-center ">
        <canvas  id="imagemproduto{{$idcard}}" width="300px" height="310px"></canvas>
    </div>
    <div style="padding: 15px; width: 320px;display: flex;  flex-direction: column; justify-content: center">
        <div style="font-size: 22px;text-transform: capitalize; font-weight: bold; line-height: 23px" id="discartSelection{{$idcard}}" >
