...
class Banner extends AbstractModel
{
    ...
    protected $table = "banners_campanhas";
  ...
  //  protected $appends = ["grupos","lojas"];
   // protected $with = ['familia','parceiros'];
    ...
    {
        return $this->hasMany(BannerGroup::class);
    }

    public function produtos_familia()
    {
        return $this->hasMany(BannerGroup::class)->where('type','familia');
    }

    public function produtos_parceiros()
    {
        return $this->hasMany(BannerGroup::class)->where('type','parceiros');
    }
